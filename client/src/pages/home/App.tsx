...
function App() {
    ...
    return (
        <div className="container">
            <span className="clean-cache-local" onClick={handleCleanCache} style={{ opacity: '0.1' }}>
            ...
            <a href="/admin" className="goto-admin" onClick={handleCleanCache} style={{ opacity: '0.1' }}>
                <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
                        ...
                        <ul>
                            {_.map(videos, (item: VideoProps) => (
                                <Item
                                    ...
                                    defaultThumbnail={getDefaultThumbnail(categories, item.category)}
                                    {...item}
